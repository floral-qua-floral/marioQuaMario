...
public abstract class DoorBlockMixin implements Bappable {
	...
	@Override
	public void cfa$onBapped(CfaData data, World world, BlockPos pos, BlockState blockState, Direction direction, int strength, BapResult result) {
		Bappable.super.cfa$onBapped(data, world, pos, blockState, direction, strength, result);
