...
public record BappingRule(int ceilingBumpStrength, int floorBumpStrength, int wallBumpStrength, CfaStat wallBumpSpeedThreshold) {
	/**
	...
	public static final CfaStat DEFAULT_WALL_BUMP_SPEED_THRESHOLD = new CfaStat(0.3, StatCategory.THRESHOLD);
	...
	public BappingRule variate(Integer ceilingBumpStrength, Integer floorBumpStrength, Integer wallBumpStrength, CfaStat wallBumpSpeedThreshold) {
