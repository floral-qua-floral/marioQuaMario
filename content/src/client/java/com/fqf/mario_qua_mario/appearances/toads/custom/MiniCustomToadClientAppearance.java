...
public class MiniCustomToadClientAppearance extends AbstractMiniToadClientAppearance {
	...
	public @NotNull Identifier getID() {
		return MiniCustomToadCommonAppearance.ID;
	}
	...
	public void accumulateCustomFeatureRenderers(ImmutableList.Builder<FeatureRenderer<AbstractClientPlayerEntity, AppearanceModel>> builder, FeatureRendererContext<AbstractClientPlayerEntity, AppearanceModel> featureRendererContext, EntityRendererFactory.Context ctx) {
		builder.addAll(CustomizableTextureLayerFeature.makeCustomToadFeatures(featureRendererContext, "mini", CustomizableTextureLayerFeature.SpotsMode.DEFAULT));
	}
