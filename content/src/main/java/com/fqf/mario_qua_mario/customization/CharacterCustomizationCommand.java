...
public class CharacterCustomizationCommand {
	public static LiteralCommandNode<ServerCommandSource> getCustomizeToadBranch() {
		return literal("customize_toad")
				.then(literal("reset")
	...
	public static LiteralArgumentBuilder<ServerCommandSource> getCustomizeCharacterBranch() {
		return literal("customize_skin")
				.then(literal("reset")
						.executes(commandContext -> {
