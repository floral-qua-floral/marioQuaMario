...
public enum AsymmetricalEasing {
	...
	AsymmetricalEasing(EasingFunction function) {
		this.FUNCTION = function;
	}

	public static float asymmetricEase(float x, AsymmetricalEasing first, AsymmetricalEasing second) {
