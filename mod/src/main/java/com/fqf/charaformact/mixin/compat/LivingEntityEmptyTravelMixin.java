...
//		if(thisAsEntity instanceof PlayerEntity thisAsPlayer && thisAsPlayer.cfa$getCfaData().doCustomTravel()
//				&& !thisAsEntity.getWeaponStack().isOf(Items.FIREWORK_STAR)
//				&& !thisAsEntity.getWeaponStack().isOf(Items.FIRE_CHARGE)
//		) {
//			CharaFormAct.LOGGER.info("Doing empty LivingEntity travel for {}", this);
//		}
//		else {
