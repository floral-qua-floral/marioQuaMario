...
public class PlayermodelListener implements SimpleSynchronousResourceReloadListener {
	...
	public Identifier getFabricId() {
		return Identifier.of(this.NAMESPACE, "cfa_playermodels");
	}
...
//							CharaFormAct.LOGGER.info("This model has a tail! {} @ {}", element, element.getPos());
//						}
//						else {
//							CharaFormAct.LOGGER.info("This model has no CAPE, which means no tail.");
//						}
