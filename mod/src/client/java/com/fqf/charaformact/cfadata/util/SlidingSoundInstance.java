...
public class SlidingSoundInstance extends AbstractSlidingSoundInstance {
	public SlidingSoundInstance(SoundEvent soundEvent, CfaClientDataImpl data) {
	...
	protected void updatePitchVolume() {
		...
		this.volume = Math.min(1.0F, ((float) this.ticks) / 3.0F) * Math.min(1.0F, 0.7F * slidingSpeed) * 0.4F;
